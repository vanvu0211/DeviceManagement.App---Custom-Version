...
namespace FabLab.DeviceManagement.DesktopApplication.Core.Application.ViewModels
{
    public class MainViewModel : BaseViewModel
    {
        ...
        public DeviceManagementViewModel DeviceManagementViewModel { get; set; }
        public EquipmentTypeViewModel EquipmentTypeViewModel { get; set; }
        public SupplierLocationTagViewModel SupplierLocationTagViewModel { get; set; }
        ...
        public MainViewModel(IDatabaseSynchronizationService databaseSynchronizationService,ISignalRClient signalRClient, IApiService apiService, DeviceManagementViewModel deviceManagementViewModel,EquipmentTypeViewModel equipmentTypeViewModel,SupplierLocationTagViewModel supplierLocationTagViewModel, DeviceManagementNavigationViewModel deviceManagementNavigation, ProjectManagementNavigationViewModel projectManagementNavigation, BorrowReturnNavigationViewModel borrowReturnNavigation, CreateNewLendRequestViewModel createNewLendRequest, MaintenanceNavigationViewModel maintenanceNavigation, FablabSuperviseViewModel fablabSupervise, ViamLabSuperviseViewModel viamLabSupervise)
        {
            ...
            SupplierLocationTagViewModel = supplierLocationTagViewModel;
